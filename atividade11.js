...
console.log("----------------------------------------------");
var opcao = parseInt(teclado("Digite o número do modelo desejado: "));
if (opcao == 1) {
    vcarros = civic;
}
else if (opcao == 2) {
...
if (formaPagamento == 1) {
    ...
    console.log("O valor do carro com desconto \u00E9: R$ ".concat(vcarros));
}
else if (formaPagamento == 2) {
    vcarros = vcarros * acrescimo;
    console.log("O valor do carro parcelado \u00E9: R$ ".concat(vcarros));
}
else {
    console.log("Opção inválida. Tente novamente.");
}
